...
--
-- Host: localhost    Database: youth_fitness
-- ------------------------------------------------------
...
--
-- Table structure for table `coach_assignments`
--
...
--
-- Dumping data for table `coach_assignments`
--

LOCK TABLES `coach_assignments` WRITE;
/*!40000 ALTER TABLE `coach_assignments` DISABLE KEYS */;
INSERT INTO `coach_assignments` VALUES (1,5,7,6,'2026-06-17 13:17:05','2026-06-17 13:17:05');
/*!40000 ALTER TABLE `coach_assignments` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `coach_messages` WRITE;
/*!40000 ALTER TABLE `coach_messages` DISABLE KEYS */;
/*!40000 ALTER TABLE `coach_messages` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `daily_wellness_logs`
--
...
--
-- Dumping data for table `daily_wellness_logs`
--

LOCK TABLES `daily_wellness_logs` WRITE;
/*!40000 ALTER TABLE `daily_wellness_logs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `daily_wellness_logs` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `exercise_reminder_logs`
--

DROP TABLE IF EXISTS `exercise_reminder_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `exercise_reminder_logs`
--

LOCK TABLES `exercise_reminder_logs` WRITE;
/*!40000 ALTER TABLE `exercise_reminder_logs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `exercise_reminder_logs` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `parent_youth_relationships`
--

DROP TABLE IF EXISTS `parent_youth_relationships`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `parent_youth_relationships`
--

LOCK TABLES `parent_youth_relationships` WRITE;
/*!40000 ALTER TABLE `parent_youth_relationships` DISABLE KEYS */;
INSERT INTO `parent_youth_relationships` VALUES (1,8,7,'parent','HYXGOI',1,'2026-06-17 13:08:35','2026-06-17 13:13:35');
/*!40000 ALTER TABLE `parent_youth_relationships` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `user_workout_logs`
--

LOCK TABLES `user_workout_logs` WRITE;
/*!40000 ALTER TABLE `user_workout_logs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `user_workout_logs` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `workout_library`
--
...
--
-- Dumping data for table `workout_library`
--

LOCK TABLES `workout_library` WRITE;
/*!40000 ALTER TABLE `workout_library` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `workout_library` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-07-15 16:54:45
